...
| **As-built S5-I1** pipeline wire + isolation + TTL (FR-IX-028) | [indexing spec](../openspec/specs/indexing/spec.md) · [design](../openspec/specs/indexing/design.md) · archive [s5-i1-document-store-pipeline-wire](../openspec/changes/archive/2026-08-12-s5-i1-document-store-pipeline-wire/) · [implementation-plan Phase 5 / 5.3–5.6](../Feasibility_Study/implementation-plan.md) |
