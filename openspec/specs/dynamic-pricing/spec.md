...
| Field | Value |
|-------|--------|
| **Status** | Phase 2a **implemented and verified (2026-08-11)** — `app/services/pricing/` package built, category-name mapping fixed, real per-asset guardrail clamping live. Phase 2c **implemented and verified (2026-08-11)** — `POST /internal/v1/pricing/quote` live, reusing `predict_price(...)`, 5 new tests, 149 total passing. Phase 2b (lean pipeline wiring) not yet implemented; Phase 3 (real-data blend + scheduled retrain) not yet implemented |
