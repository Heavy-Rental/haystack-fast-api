...
| 2.10.0 | 2026-08-13 (Phase 2d-ii implemented) | Recalibrated synthetic anchors, guardrail bands, and duration curve jointly; generated versioned v2 data and trained `model_v2.pkl`/`current_v2.json`. Strict generation checks passed; candidate holdout MAE 16.64, R² 0.9866. Serving artifacts unchanged; validation/promotion remain gated. |
