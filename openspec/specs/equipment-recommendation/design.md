...
Live Neo4j **job + T4 triggers** are as-built in the config pack (`neo4j-populate`, post-sync HTTP, admin `:8089`). App `neo4j_cypher_read` / populate trigger remain fake until **S8.3**.
