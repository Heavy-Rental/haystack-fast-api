...
| S3 agent gate (as-built) | Indexing — `run_indexing_from_request` + Coordinator gate **[4]** behind `INDEXING_VIA_AGENT_GATE` (default off) | `app/agents/indexing_gate.py` · `app/agents/tools.py` · impl-plan **Phase 3 / S3**; lean body unchanged |
