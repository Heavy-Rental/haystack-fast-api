...
- [ ] **New (2026-08-11):** richer Spring Boot seed data (`openspec/specs/domain-seed-data/spec.md`) — external dependency, tracked here for coordination but not a Haystack branch/subtask. Doesn't block building/relocating the pricing service, but blocks meaningful verification (period_utilization spot-checks, differentiated per-asset demo pricing) of Phase 2's own acceptance scenarios. Flag to Spring Boot side; re-run this file's verification steps once landed.
