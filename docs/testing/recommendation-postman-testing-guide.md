...
| Field | Value |
|-------|--------|
| **Document type** | SDD verification guide (Postman-focused; not behaviour SoT) |
...
| **Pipeline SDD (service)** | [`openspec/specs/recommendation-pipeline/spec.md`](../../openspec/specs/recommendation-pipeline/spec.md) |
...
| Spec | Role |
|------|------|
| [`recommendation-pipeline-testing-guide.md`](./recommendation-pipeline-testing-guide.md) | Full guide (pytest + curl + Postman + LLM) |
| [`openspec/specs/recommendation-pipeline/spec.md`](../../openspec/specs/recommendation-pipeline/spec.md) | Normative FR-010.1–8 pipeline |
| [`openspec/specs/recommendation-intake/spec.md`](../../openspec/specs/recommendation-intake/spec.md) | API contract |
| [`openspec/changes/archive/2026-08-07-hr-65-intake-front/`](../../openspec/changes/archive/2026-08-07-hr-65-intake-front/) | LLM integration notes (historical) |
...
| **1.2.0** | 2026-08-10 | Moved under `docs/testing/`; links to openspec |

**Reading order:** [Map](../../openspec/AGENTS.md) · **Live Postman:** [`../../postman/README.md`](../../postman/README.md) (not this deferred guide)
